...
/**
 * changeDirectoryDot - Handle the 'cd .' command.
...
/**
 * changeDirectoryTo - Handle the 'cd' command.
 * @datash: The data_shell structure.
*/
void changeDirectoryTo(data_shell *datash)
{
	char pwd[PATH_MAX];
...
/**
 * changeDirectoryPrevious - Handle the 'cd -' command.
 * @datash: The data_shell structure.
*/
void changeDirectoryPrevious(data_shell *datash)
{
	char pwd[PATH_MAX];
...
/**
 * changeDirectoryToHome - Handle the 'cd' with no arguments or 'cd ~' command.
 * @datash: The data_shell structure.
*/
void changeDirectoryToHome(data_shell *datash)
{
	char *p_pwd, *home;
	char pwd[PATH_MAX];
