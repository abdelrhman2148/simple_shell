...
/**
 * appendErrorMessage - Appends error message components.
...
/**
 * generateCdError - Generates an error message for the 'cd' command.
 * @datash: The data_shell structure.
...
char *generateCdError(data_shell *datash)
{
	...
	error = appendErrorMessage(datash, msg, error, ver_str);
	free(ver_str);
	return (error);
}

/**
 * generateNotFoundError - Generates an error message for a command not found.
 * @datash: The data_shell structure.
 * Return: The error message.
*/
...
/**
 * generateExitError - Generates an error message for the 'exit' command.
 * @datash: The data_shell structure.
 * Return: The error message.
*/
